      ...
      <Div>
        <Div bg="black" h={'100%'}>
          ...
          >
            ...
            <Div h={300}>
              <Div row flexWrap="wrap" justifyContent="space-evenly" bg={black} p="lg"w={'30%'} rounded='xl'>
